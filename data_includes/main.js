...
Sequence("Consent", "Welcome", "Start", "party", "AlienIntro", "GroupingIntro", "Reminder1", "Grouping1", "Reminder2", "Grouping2", "GroupingFlower", "Reminder3", "Grouping3", "Reminder4", "Grouping4", "LearningIntro1", "LearningIntro2",
...
CheckPreloaded("SuffixSelection", "AlienSelection", "LikertScale")
...
//Introduce the grouping activity

newTrial("party",
  noTopMargin(),
  
  newHtml("partyblue.html")
    .log()
    .print()
  ,
  newVar("RT").global().set( v=> Date.now()),
...
newTrial("AlienIntro",
noTopMargin(),
  newText("Nulus1", "Nulu wearing the pink flower")
  .css("font-size", "1.5em")
  .log()
  ,
  newText("Nulus2", "Nulu wearing the blue flower")
  .css("font-size", "1.5em")
  .log()
  ,
  newText("Gilis1", "Gili wearing the pink flower")
  .css("font-size", "1.5em")
  .log()
  ,
  newText("Gilis2", "Gili wearing the blue flower")
  .css("font-size", "1.5em")
  .log()
  ,
...
newTrial("Grouping1",
 noTopMargin(),
newImage("Alien1" , "A1_1a.png")
    .size(140, 180)
,
newImage("Alien2" , "A1_2a.png")
    .size(140, 180)
,
newImage("Alien3" , "A2_1a.png" )
    .size(140, 180)
,
newImage("Alien4" , "A2_2a.png")
    .size(140, 180)
,
newImage("Alien5" , "A3_1a.png" )
    .size(140, 180)
,
newImage("Alien6" , "A3_2a.png" )
  .size(140, 180)
,
newImage("Alien7" , "A4_1a.png" )
    .size(140, 180)
,
newImage("Alien8" , "A4_2a.png" )
    .size(140, 180)
,
newImage("Alien9" , "B1_1a.png")
    .size(140, 180)
,
newImage("Alien10" , "B1_2a.png" )
    .size(140, 180)
,
newImage("Alien11" , "B2_1a.png" )
    .size(140, 180)
,
newImage("Alien12" , "B2_2a.png" )
    .size(140, 180)
,
newImage("Alien13" , "B3_1a.png" )
    .size(140, 180)
,
newImage("Alien14" , "B3_2a.png" )
    .size(140, 180)
,
newImage("Alien15" , "B4_1a.png" )
    .size(140, 180)
,
newImage("Alien16" , "B4_2a.png" )
    .size(140, 180)
,
newButton("1", "1")
...
// Staring grouping of flowers

newTrial("GroupingFlower",
  noTopMargin(),

  newText("<p> Now you’ve learned to distinguish the different aliens, we’ll practice distinguishing the different flowers </p>")
  .css("font-size", "1.5em")
  .center()
  .print()
  .log()
...
newTrial("Reminder3",
  noTopMargin(),
  newText("<p> Here are a Nulu and a Gili wearing the pink flower.</p>")
  .css("font-size", "1.5em")
  .center()
  .print()
  ,
...
newCanvas( 'myCanvas', "90vw", "68vh")
    ...
    .print()
  ,
 newText("<p> Please find all the images of aliens wearing the pink flower and type their numbers in this box. Please separate numbers with commas. Press enter when you are done. </p>")
 .css("font-size", "1.2em")
 .center()
 .print()
 .log()
...
newTrial("Reminder4",
 noTopMargin(),
  newText("<p> Here are a Nulu and a Gili wearing the blue flower.</p>")
  .css("font-size", "1.5em")
  .center()
  .print()
  .log()
...
newCanvas( 'myCanvas', "90vw", "68vh")
    ...
    .print()
  ,
 newText("<p> Please find all the images of aliens wearing the blue flower and type their numbers in this box. Please separate numbers with commas. Press enter when you are done. </p>")
 .css("font-size", "1.2em")
 .center()
 .print()
 .log()
...
//Likert scale
Template("LikertScale.csv", row=>

newTrial("LikertScale",
...
,
   ...
   newText("scalequestion", "How likely do you think it is that this alien would use this word?")
   .print("62vw", "75vh")
   .log()
,
    newScale("likert", 7)
    .labelsPosition("top")
    .before(newText("left", "Very unlikely") )
    .after( newText("right", "Very likely") )
    .log("first", "last")
    .print("62vw", "80vh" )
    .wait()
,
  ...
  // newText("How likely do you think this alien might have said the word.")
  //.center()
  //.css("font-size", "1.5em")
 // .print("60vw", "90vh")
  //.log()
...
.log("ScalingTime", getVar("RT"))
.log("ItemTested", row.ItemImageFile)
.log("AlienTested", row.AlienImageFile)
.log("WordTested", row.Item)
